// Example program #3 from Chapter9 of Absolute Beginner's Guide to
// C, 3rd Edition
// File Chapter9ex3.c
...
int main()
{
  ...
  /* The student got 88s on the first and third test,
     so a multiple assignment works. */
  grade1 = grade3 = 88;
  grade2 = 79;
  ...
  percentDiff = 100 * ((95 - averageGrade) / 95); // Don't know why the authors didn't just do: percentDiff = 100 * (gradeDelta / 95); instead here.
